    ...
    <footer className="bg-[#0A0A0A] border-t border-white/10 pt-16 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-16">
          ...
          <div className="lg:col-span-2 space-y-4">
            <Link href="/" className="flex items-center gap-2 text-xl font-bold tracking-tight text-white">
              <span className="w-3 h-3 bg-[#FFE500] rounded-sm" />
            ...
            <div className="pt-2 text-xs text-neutral-500 font-mono">
              LOCATION: [NEW DELHI / GLOBAL HUB] · EMAIL: hello@sparkmedia.ad
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm text-neutral-400">
              ...
              <li><Link href="/services/email-sms" className="hover:text-white transition-colors">Email / SMS / WhatsApp</Link></li>
              <li><Link href="/services/web-design" className="hover:text-white transition-colors">Web Design & Dev</Link></li>
              <li><Link href="/services/branding" className="hover:text-white transition-colors">Brand & Campaigns</Link></li>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm text-neutral-400">
              ...
              <li><a href="mailto:hello@sparkmedia.ad" className="hover:text-white transition-colors">hello@sparkmedia.ad</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-neutral-500">
          <p>© 2026 SparkMedia.ad. All rights reserved.</p>
